...
gender_enum = Enum('мужской', 'женский', 'детский', name='gender_enum', schema='public')
...
class Order(db.Model):
    ...
    sweatwear = db.relationship("Sweatwear", backref="order_sweatwer", lazy=True)
    ...
    accessory = db.relationship("Accessories", backref="order_accessory", lazy=True)
...
class Review(db.Model):
    ...
    sweatwear = db.relationship("Sweatwear", backref="review_sweatwear", lazy=True)
    ...
    trousers = db.relationship("Trousers", backref="review_trouesers", lazy=True)
    accessory = db.relationship("Accessories", backref="review_accessory", lazy=True)
